    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand text-primary" href="<?= BASE_PATH ?>">BLOGAPART</a>
                    ...
                    <?php if (isset($_SESSION['user']['roles']) && in_array('ROLE_ADMIN', $_SESSION['user']['roles'])) : ?>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item text-black-50" href="<?= BASE_PATH ?>admin">Accueil</a>
                                <a class="dropdown-item text-black-50" href="<?= BASE_PATH ?>admin/categories">Gestion catégories</a>
                                <a class="dropdown-item text-black-50" href="<?= BASE_PATH ?>admin/annonces">Gestion annonces</a>
                                <a class="dropdown-item text-black-50" href="<?= BASE_PATH ?>admin/users">Gestion utilisateurs</a>
                            </div>
                        </div>
                    <?php endif; ?>
